...
$outputfile = "$env:USERPROFILE\Downloads\Adobe-Acrobat64-Setup\AcroRdrDC2300120143_nl_NL.exe"
$webclient.DownloadFile($url, $outputfile)

Write-Host "Extracting .EXE file to individual files..."
Start-Process -FilePath "$env:USERPROFILE\Downloads\Adobe-Acrobat64-Setup\AcroRdrDC2300120143_nl_NL.exe" -ArgumentList "-sfx_o`"$env:USERPROFILE\Downloads\Adobe-Acrobat64-Setup`" -sfx_ne -quiet" -Wait
